/// Generated resource class for random:index/randomInteger:RandomInteger.
///
...
class RandomInteger extends CustomResource {
  ...
  final RandomIntegerArgs _args;

  /// Creates a new RandomInteger resource.
  RandomInteger(
    String name,
    RandomIntegerArgs args, {
    CustomResourceOptions? options,
  }) : _args = args,
       super('random:index/randomInteger:RandomInteger', name, options);
  ...
  void processOutputs(Struct properties) {
    ...
    max = Output.of((properties.fields['max']?.numberValue ?? 0).toInt());
    min = Output.of((properties.fields['min']?.numberValue ?? 0).toInt());
    result = Output.of((properties.fields['result']?.numberValue ?? 0).toInt());
    seed = Output.of(properties.fields['seed']?.stringValue);
  }
}

/// Arguments for creating a RandomInteger resource.
