/// Generated resource class for random:index/randomUuid:RandomUuid.
///
/// ## Example Usage
/// 
...
class RandomUuid extends CustomResource {
  ...
  final RandomUuidArgs _args;

  /// Creates a new RandomUuid resource.
  RandomUuid(
    String name,
    RandomUuidArgs args, {
    CustomResourceOptions? options,
  }) : _args = args,
       super('random:index/randomUuid:RandomUuid', name, options);
...
/// Arguments for creating a RandomUuid resource.
