/// Generated resource class for random:index/randomUuid4:RandomUuid4.
///
...
class RandomUuid4 extends CustomResource {
  ...
  final RandomUuid4Args _args;

  /// Creates a new RandomUuid4 resource.
  RandomUuid4(
    String name,
    RandomUuid4Args args, {
    CustomResourceOptions? options,
  }) : _args = args,
       super('random:index/randomUuid4:RandomUuid4', name, options);
...
/// Arguments for creating a RandomUuid4 resource.
